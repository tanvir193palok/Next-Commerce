    ...
    <div className="col-span-8 border border-gray-200 p-4 rounded">
      ...
      <div className="space-y-4 text-sm lg:text-base">
        ...
        <form onSubmit={onSubmit}>
          ...
          <button
            type="submit"
            className="block w-full py-2 md:py-3 px-4 text-center text-white bg-primary border border-primary rounded-md hover:bg-transparent hover:text-primary transition font-medium"
          >
            Place order
          </button>
        </form>
